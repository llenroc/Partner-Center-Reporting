...
namespace Microsoft.Store.PartnerCenter.Reporting.Api.Services
{
    ...
    {
        /// <summary>
        /// Provides access to core application providersk.
        /// </summary>
        ...
        /// </exception>
        public GraphService(IAppService service, string customerId)
        {
        ...
        /// </exception>
        public GraphService(IAppService service, IGraphServiceClient client)
        {
            service.AssertNotNull(nameof(service));
        ...
        /// </exception>
        public async Task<List<RoleModel>> GetRolesAsync(string objectId)
        {
            DateTime startTime;
